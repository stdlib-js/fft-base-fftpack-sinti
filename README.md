...
```javascript
sinti = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/fft-base-fftpack-sinti@umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var sinti = require( 'path/to/vendor/umd/fft-base-fftpack-sinti/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/fft-base-fftpack-sinti@umd/browser.js"></script>
```
